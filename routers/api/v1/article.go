...
// GetArticles gets multiple articles
func GetArticles(c *gin.Context) {
	...
	if arg := c.Query("state"); arg != "" {
		...
		valid.Range(state, 0, 1, "state").Message("状态只有0和1")
	}
...
func EditArticle(c *gin.Context) {
	...
	valid.MaxSize(content, 65535, "modified_by").Message("修改人不能为空")
